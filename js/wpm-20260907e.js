...
function tableRail(){
  ...
  return `<div class="panel rail-card"><div class="kicker">GPA table</div>${g||"<p class='empty'>Loading table…</p>"}<a class="chip" href="/rankings">Full table</a></div><div class="panel rail-card"><div class="kicker">Pro ELO</div>${e||"<p class='empty'>ELO loading…</p>"}</div>`;
}
function weekStrip(){
